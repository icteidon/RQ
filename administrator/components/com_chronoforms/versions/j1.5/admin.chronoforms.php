...
class ChronoFormsAdminVersion extends JObject{
	...
	function __getValStatus(){
		...
		$database->setQuery("SELECT * FROM #__components WHERE `parent`='0' AND `option`='com_chronoforms' AND `admin_menu_link`='option=com_chronoforms'");
