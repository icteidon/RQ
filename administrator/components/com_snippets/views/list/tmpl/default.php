...
echo $versions->getMessage('snippets', '', $version);
?>

<form action="<?php echo JRoute::_('index.php?option=com_snippets&view=list'); ?>" method="post"
	...
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			<select name="filter_state" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', SnippetsHelper::publishedOptions(), 'value', 'text', $this->state->get('filter.state'), true);?>
			</select>
		</div>
	</fieldset>
	<div class="clr"></div>
