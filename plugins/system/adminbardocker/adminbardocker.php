...
/**
 * Plugin that places the adminbar docker icons
 */
class plgSystemAdminBarDocker extends JPlugin
{
	...
	function onAfterRoute()
	{
		...
		if (JRequest::getCmd('disable_adminbardocker')
		...
		if (!JFile::exists(JPATH_PLUGINS.'/system/nnframework/nnframework.php')) {
			if ($app->isAdmin() && JRequest::getCmd('option') !== 'com_login') {
				$msg = JText::_('ABD_NONUMBER_FRAMEWORK_NOT_INSTALLED');
				$msg .= ' '.JText::sprintf('ABD_EXTENSION_CAN_NOT_FUNCTION', JText::_('ADMINBAR_DOCKER'));
