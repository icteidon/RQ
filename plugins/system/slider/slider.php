...
/**
 * System Plugin that places a Slider code block into the text
 */
class plgSystemSlider extends JPlugin
{
	...
	function onAfterRoute()
	{
		...
		if (
			JRequest::getCmd('disable_slider')
		...
		if (!JFile::exists(JPATH_PLUGINS.'/system/nnframework/nnframework.php')) {
			if ($app->isAdmin() && JRequest::getCmd('option') !== 'com_login') {
				$msg = JText::_('SLD_NONUMBER_FRAMEWORK_NOT_INSTALLED');
				$msg .= ' '.JText::sprintf('SLD_EXTENSION_CAN_NOT_FUNCTION', JText::_('SLIDER'));
