...
window.elFinder = function(node, opts) {
	...
	this
		...
		.bind('rm', function(e) {
			...
			play && play != '' && play != 'no' && $(beeper).html('<source src="../media/k2/assets/sounds/rm.wav" type="audio/wav">')[0].play()
		})
...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.en = {
		...
		messages   : {
			...
			'errReplByChild'       : 'The folder β$1β canβt be replaced by an item it contains.',
...
elFinder.prototype.commands.help = function() {
	...
	this.fm.one('open', function() {
		setTimeout(function() {
			...
			html.push('<div class="'+lic+'">Copyright Β© 2009-2011, Studio 42</div>');
			html.push('<div class="'+lic+'">β β¦'+fm.i18n('dontforget')+' β</div>');
			html.push('</div>');
			// end main
...
/*
 * File: /home/troex/Sites/git/elfinder-2.x/js/commands/resize.js
 */
